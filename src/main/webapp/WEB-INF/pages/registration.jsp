...
<html>
<head>
	<title>MyBookShop-Регистрация</title>
	...
	<div class="centre">
		<div id="reg">
			<form id="reg-form" action="" method="POST">
				...
				<div class="regDiv">
					<label for="r_password"><span class="formTextRed">*</span>Повторить пароль:</label>
					<input type="password" name="r_password" id="r_password" required="required"
					pattern="[A-Za-z0-9_-]{6,20}" onchange="checkPass(this.form)"/>
				</div>
				<div id="nameDiv" class="regDiv">
					<label for="name">Имя:</label>
					<input type="text" name="name" id="name" />
				</div>
				<div id="surnameDiv" class="regDiv">
				...
				<div class="regDiv">
					<label for="phone"><span class="formTextRed">*</span>Телефон:</label>
				...
				<div id="photoDiv" class="regDiv">
					...
					<input type="file" id="picture" name="image" accept="image/jpeg,image/png,image/gif">
				</div>
				<div id="checkbox">
				...
				<div class="submit">
					<input type="submit" name="send" value="Регистрация" class="btm" disabled="disabled" onclick="return sendRegData(this.form)" />
				</div>
			</form>
		</div>
	</div>
