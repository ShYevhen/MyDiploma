...
<div class="body">
	...
	<div class="centre">
		<div class="top">
			<div id="one">
			<div id="bookNavibar">
				<select id="orderSel" class="chosen-select" onchange="orderSelected()">
					<option value=""></option>
					<option value="${genreLink}">Новинки</option>
					<option value="${genreLink}?order=populary">По рейтингу</option>
					<option value="${genreLink}?order=price&sortS=ASC">От дешевых к дорогим</option>
					<option value="${genreLink}?order=price&sortS=DESC">От дорогих к дешевым</option>
					<option value="${genreLink}?order=name&sortS=ASC">По названию(А...Я)</option>
					<option value="${genreLink}?order=name&sortS=DESC">По названию(Я...А)</option>
				</select>
			</div>
			<div id="bookSearch">
				<form action="/search" method="GET">
					<div class="input" id="search">
						<input type="text" name="search_text" required="required" placeholder="Найти книгу по названию">
