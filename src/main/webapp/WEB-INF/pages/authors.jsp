			...
			<div class="navibar">
				<form action="/search" method="GET">
					<div class="input" id="search">
						<input type="text" name="search_author" required="required" placeholder="Найти автора по фамилии или имени">
						<button type="submit" class="btm" id="btm_search">Найти</button>
					</div>
				</form>
				<div class="letter">
					<ul class="alphabet">
						<li><a href="/authors?letter=А">A</a></li>
						<li><a href="/authors?letter=Б">Б</a></li>
						<li><a href="/authors?letter=В">В</a></li>
						<li><a href="/authors?letter=Г">Г</a></li>
						<li><a href="/authors?letter=Д">Д</a></li>
						<li><a href="/authors?letter=Е">Е</a></li>
						<li><a href="/authors?letter=Ж">Ж</a></li>
						<li><a href="/authors?letter=З">З</a></li>
						<li><a href="/authors?letter=И">И</a></li>
						<li><a href="/authors?letter=Й">Й</a></li>
						<li><a href="/authors?letter=К">К</a></li>
						<li><a href="/authors?letter=Л">Л</a></li>
						<li><a href="/authors?letter=М">М</a></li>
						<li><a href="/authors?letter=Н">Н</a></li>
						<li><a href="/authors?letter=О">О</a></li>
						<li><a href="/authors?letter=П">П</a></li>
						<li><a href="/authors?letter=Р">Р</a></li>
						<li><a href="/authors?letter=С">С</a></li>
						<li><a href="/authors?letter=Т">Т</a></li>
						<li><a href="/authors?letter=У">У</a></li>
						<li><a href="/authors?letter=Ф">Ф</a></li>
						<li><a href="/authors?letter=Х">Х</a></li>
						<li><a href="/authors?letter=Ц">Ц</a></li>
						<li><a href="/authors?letter=Ч">Ч</a></li>
						<li><a href="/authors?letter=Ш">Ш</a></li>
						<li><a href="/authors?letter=Щ">Щ</a></li>
						<li><a href="/authors?letter=Э">Э</a></li>
						<li><a href="/authors?letter=Ю">Ю</a></li>
						<li><a href="/authors?letter=Я">Я</a></li>
					</ul>
				</div>
			</div>
		</div>
		<div class="data">
			<ul class="border">
				<c:forEach var="author" items="${authors}">
						<li>
							<a href="/authors/author?id=${author.id}">${author.surname} ${author.name}</a>
						</li>
				</c:forEach>
			</ul>
		</div>
