...
//	@Query("SELECT NEW net.ukr.shyevhen.model.Book(u.favorite.id, u.favorite.name, u.favorite.price) FROM ShopUser u WHERE u.login = :login")
//	List<Book> getFavoriteList(@Param("login")String login);
